...
// ADDED BY ABHISHEK
 --%>
<%-- <%@ include file="/html/taglib/ui/ratings/page.jsp" %> --%>

<%-- <%

String classRatingsName = (String)request.getAttribute("liferay-ui:ratings:className");
long classRatingsPK = GetterUtil.getLong((String)request.getAttribute("liferay-ui:ratings:classPK"));
...
<%-- 					<div style=" text-align:center;"> --%>
					...
					<div style="background-color:#d9d9d9; display: block; margin:10px 0; height:1px; width:100%; overflow: hidden; "></div>
					<%
