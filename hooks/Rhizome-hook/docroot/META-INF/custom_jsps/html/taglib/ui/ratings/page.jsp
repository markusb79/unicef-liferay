							...
							<div class="helper-clearfix rating-content thumbrating-content" id="<%= randomNamespace %>ratingThumbContent">
								...
								<c:choose>
									...
									<c:otherwise>
											...
											<%-- <c:if test="<%= (yourScore > 0) %>">
												<a class="rating-element rating-on rating-thumb-up icon-thumbs-up" href="javascript:;">like abc <%= yourScore %> </a>
											</c:if>
											<c:if test="<%= (yourScore == 0) %>">
												<a class="rating-element rating-off rating-thumb-down icon-thumbs-down" href="javascript:;">unlike abc <%= yourScore %></a>
											</c:if> --%> 
											
										<a class="rating-element rating-<%= (yourScore > 0) ? "on" : "off" %> rating-thumb-up icon-thumbs-up" href="javascript:;">Like</a>

										<a class="rating-element rating-<%= (yourScore < 0) ? "on" : "off" %> rating-thumb-down icon-thumbs-down" style="display: none;" href="javascript:;">unlike lappy <%= yourScore %></a>
