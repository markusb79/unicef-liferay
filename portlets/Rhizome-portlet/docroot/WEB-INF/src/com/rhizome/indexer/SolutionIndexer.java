...
public class SolutionIndexer extends BaseIndexer implements Indexer{
	...
	private static final Log logger = LogFactoryUtil.getLog(SolutionIndexer.class);

	@Autowired
	public SolutionService solutionService;
	
	@Inject
	public void initSolutionDAOFactory(SolutionService solutionService){
	...
	protected void doDelete(Object obj) throws Exception {
		...
		deleteDocument(entry.getCoInventorId(), entry.getSolutionId());
	...
	protected Document getBaseModelDocument(String portletId,Solution baseModel, Solution workflowedBaseModel) throws SystemException {
