...
<div class="body-container clearfix">
  <div class="sopd-detail-banner clearfix">
      <div class="sopd-detail-banner-box clearfix">
        ...
        <div class="sopd-detail-banner-text01"> <span>OUTBREAK RESPONSE</span> <span>Conduct a Media Landscape Analysis</span> </div>
      </div>
    </div>
    <div class="un-sp-container clearfix">
      ...
      <div id="introduction" style="margin-bottom:30px; ">
    	...
    	<div class="sopi-title01">Introduction</div>
