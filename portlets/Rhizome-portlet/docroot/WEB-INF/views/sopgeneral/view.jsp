...
<div class="body-container clearfix">
  <div class="sopd-detail-banner clearfix">
      <div class="sopd-detail-banner-box clearfix">
        <div class="sopd-detail-banner-img"> <img src="images/8_CA_EstOutRes.png"></div>
    ...
    <div class="un-sp-container clearfix">
      ...
      <div id="contentcontainer" style="width:100%; height:400px; border:1px solid #999; overflow-y:scroll;   position:relative; ">
      
      <%-- ********************** INTRODUCTION ************************* --%>
      
      <div id="introduction" style="min-height:400px; ">
	
    	<div><label style="font-weight: bold;">Introduction C</label></div>
      	...
      	<div><label style="font-weight: bold;">These SOPs introduce the following new concepts for polio outbreak response:</label></div> 
      ...
      <%-- ********************** OUTBREAK RESPONSE ************************* --%>
      <div id="outbreakRes" style="min-height:400px;">
      <div><label style="font-weight: bold;">Outbreak Response</label></div>
      ...
      <%-- ********************** GRADING ************************* --%>
      <div id="grading" style="min-height:400px;">
      <div><label style="font-weight: bold;">Grading</label></div>
      <p>
	  ...
	  <div><label style="font-weight: bold;">Grade definition</label></div>
	  ...
	  <p>
		...
		<b>3. Grade 3:</b> Significant risk of continuation and international spread of transmission due to significant gaps in population immunity, major vulnerable population clusters, a history of multi-country involvement, serious deficiencies in local in-country response capacities, high security threats and access challenges, and/or a complex humanitarian emergency (example: WPV case in Somalia or Syria).
 		...
 		<%-- ********************** STRATEGIES ************************* --%>
      <div id="strategies" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Strategies</label></div>
      	<p>
      ...
      <%-- ********************** CRITICAL FUNCTIONS ************************* --%>
      <div id="criticalFun" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Critical Function</label></div>
      ...
      <%-- ********************** CRITICAL FUNCTIONS ************************* --%>
      <div id="essenPolicies" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Essential Policies</label></div>
      ...
      <div id="performanceStand" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Performance Standards</label></div>
      ...
      <div id="within24" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Within 24 Hours</label></div>
     ...
     <%-- ********************** WITHIN 72 HOURS ************************* --%>
      <div id="within72" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Within 72 Hours</label></div>
      ...
      <%-- ********************** WITHIN 14 DAYS ************************* --%>
      <div id="within14" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Within 14 Days</label></div>
      	<ul>
       ...
       <%-- ********************** UNTIL CLOSURE ************************* --%>
      <div id="untilClose" style="min-height:400px;">
      	<div><label style="font-weight: bold;">Until Closure</label></div>
      	<ul>
